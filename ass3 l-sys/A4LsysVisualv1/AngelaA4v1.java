...
public class AngelaA4v1 extends JComponent {
 ...
 public void paint(Graphics g) {
		...
		Iterator iter = paintData.iterator();
		System.out.println("WHERE");
		
 	while(iter.hasNext()){
 		
 		segmentData = (float []) iter.next();
...
public static void getPaintData(){
	...
	while(iter.hasNext()){
		...
		segmentData = (float []) iter.next();
 		...
 		System.out.print("   char: "+segmentData[0]);
 		System.out.print("   ox "+segmentData[1]);
 		System.out.print("   oy "+segmentData[2]);
 		System.out.print("   ex "+segmentData[3]);
 		System.out.print("   ey "+segmentData[4]);
 		System.out.println("");
	}
